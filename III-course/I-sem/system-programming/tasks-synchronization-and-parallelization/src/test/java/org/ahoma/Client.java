...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    File serialized_param = null;
    try {
      serialized_param = new File(args[0]);
      ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(serialized_param));
